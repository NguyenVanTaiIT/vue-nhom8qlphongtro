            ...
            <div class="service">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-3"></div>
                        <div class="col-6">
                            <input id="oldIndex" min="1" type="number" v-model="electricWater.oldIndex" class="form-control" placeholder="Nhập chỉ số cũ " >
                            <br>
                            <input id="newIndex" min="1" type="number" v-model="electricWater.newIndex" class="form-control" placeholder="Nhập chỉ số mới " >
                            <br>
    ...
    methods:{
       ...
       async add(){
            if(this.checkValidation()==true){
                this.electricWater.rentRoomId = this.$route.params.id;
                this.electricWater.serviceName = this.nameService;
                await ElectricWaterService.create(this.electricWater);
        ...
        checkValidation(){
            ...
            let oldIndex = document.getElementById('oldIndex').value;
            ...
            if(!newIndex||!oldIndex){
                ...
                this.showAlert('Chỉ số mới phải lớn hơn chỉ số cũ!', 'warning');
                return false;
            }
            else{
                return true;
